var bt=`/* accordion component specific classes */
  ...
  <div class="feedback-form cagov-stack">
    ...
    <div class="feedback-form-add">
      ...
      <div class="feedback-form-add-grid">
        ...
        <button class="btn-light js-feedback-submit" type="submit" id="feedback-submit">${i}</button>
      </div>
    </div>

    <div class="feedback-form-thanks feedback-thanks-add" role="alert">${o}</div>
  </div>
  </section>`}var kt=`cagov-page-feedback {
  width: 100%;
}
...
`,X=class extends window.HTMLElement{connectedCallback(){let a=this.dataset.question?this.dataset.question:"Did you find what you were looking for?",t=this.dataset.yes?this.dataset.yes:"Yes",n=this.dataset.no?this.dataset.no:"No",e=this.dataset.commentPrompt?this.dataset.commentPrompt:"What was the problem?";this.positiveCommentPrompt=this.dataset.positiveCommentPrompt?this.dataset.positiveCommentPrompt:"Great! What were you looking for today?";let o=this.dataset.thanksFeedback?this.dataset.thanksFeedback:"Thank you for your feedback!",i=this.dataset.thanksComments?this.dataset.thanksComments:"Thank you for your comments!",m=this.dataset.submit?this.dataset.submit:"Submit";this.dataset.characterLimit&&this.dataset.characterLimit,this.dataset.anythingToAdd&&this.dataset.anythingToAdd,this.dataset.anyOtherFeedback&&this.dataset.anyOtherFeedback,this.endpointUrl=this.dataset.endpointUrl;let s=xt(a,t,n,e,o,i,m);this.innerHTML=s,this.applyListeners()}applyListeners(){this.wasHelpful="",this.querySelector(".js-add-feedback").addEventListener("focus",()=>{this.querySelector(".js-feedback-submit").style.display="block"});let a=this.querySelector(".js-add-feedback");a.addEventListener("keyup",()=>{a.value.length>15?a.setAttribute("rows","3"):a.setAttribute("rows","1")}),a.addEventListener("blur",()=>{a.value.length!==0&&(this.querySelector(".js-feedback-submit").style.display="block")}),this.querySelector(".js-feedback-yes").addEventListener("click",()=>{this.querySelector(".js-feedback-field-label").innerHTML=this.positiveCommentPrompt,this.querySelector(".js-feedback-form").style.display="none",this.querySelector(".feedback-form-add").style.display="block",this.wasHelpful="yes",this.dispatchEvent(new CustomEvent("ratedPage",{detail:this.wasHelpful}))}),this.querySelector(".js-feedback-no").addEventListener("click",()=>{this.querySelector(".js-feedback-form").style.display="none",this.querySelector(".feedback-form-add").style.display="block",this.wasHelpful="no",this.dispatchEvent(new CustomEvent("ratedPage",{detail:this.wasHelpful}))}),this.querySelector(".js-feedback-submit").addEventListener("click",()=>{this.querySelector(".feedback-form-add").style.display="none",this.querySelector(".feedback-thanks-add").style.display="block";let t={};t.url=window.location.href,t.helpful=this.wasHelpful,t.comments=a.value,t.userAgent=navigator.userAgent,fetch(this.endpointUrl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}).then(n=>n.json()).then(n=>console.log(n))})}};window.customElements.define("cagov-page-feedback",X);var rt=document.createElement("style");rt.textContent=kt;document.querySelector("head").appendChild(rt);var U=class extends window.HTMLElement{connectedCallback(){this.innerHTML=`<div class="accordion-icon" aria-hidden="true">
      ...
      </div>`}};window.customElements.define("cagov-minus",U);function B(c,a){return`<li class="cagov-pagination__item">
    <a
  ...
  </li>`}function it(){return`<li
    class="cagov-pagination__item cagov-pagination__overflow"
    role="presentation"
  >
    <span> \u2026 </span>
  </li>`}function Dt(c,a,t,n,e){return`<nav aria-label="Pagination" class="cagov-pagination">
    <ul class="cagov-pagination__list">
      ...
      <li class="cagov-pagination__item">
        <a
          ...
          aria-label="${c} ${t}"
        >
          <span class="cagov-pagination__link-text ${n>e-1?"cagov-pagination__link-inactive":""}"> ${c} </span>
        </a>
      </li>
    </ul>
  </nav>`}var Nt=`cagov-pagination .cagov-pagination__list {
  list-style: none;
  margin: 0;
  padding: 0 !important;
  display: flex;
...
/*# sourceMappingURL=index.css.map */
`,V=class extends window.HTMLElement{connectedCallback(){this.currentPage=parseInt(this.dataset.currentPage?this.dataset.currentPage:"1",10),this.render()}render(){let a=this.dataset.previous?this.dataset.previous:"&#60;",t=this.dataset.next?this.dataset.next:"&#62;",n=this.dataset.page?this.dataset.page:"Page";this.totalPages=this.dataset.totalPages?this.dataset.totalPages:"1";let e=Dt(t,a,n,this.currentPage,this.totalPages);this.innerHTML=e,this.applyListeners()}static get observedAttributes(){return["data-current-page","data-total-pages"]}attributeChangedCallback(a,t,n){a==="data-current-page"&&(this.currentPage=parseInt(n,10),this.render())}applyListeners(){this.querySelectorAll(".cagov-pagination__button").forEach(t=>{t.addEventListener("click",n=>{this.currentPage=parseInt(n.target.dataset.pageNum,10),this.dispatchEvent(new CustomEvent("paginationClick",{detail:this.currentPage})),this.dataset.currentPage=this.currentPage})}),this.querySelector(".cagov-pagination__previous-page").addEventListener("click",t=>{t.target.classList.contains("cagov-pagination__link-inactive")||(this.currentPage-=1,this.currentPage<1&&(this.currentPage=1),this.dispatchEvent(new CustomEvent("paginationClick",{detail:this.currentPage})),this.dataset.currentPage=this.currentPage)}),this.querySelector(".cagov-pagination__next-page").addEventListener("click",t=>{t.target.classList.contains("cagov-pagination__link-inactive")||(this.currentPage+=1,this.currentPage>this.totalPages&&(this.currentPage=this.totalPages),this.dispatchEvent(new CustomEvent("paginationClick",{detail:this.currentPage})),this.dataset.currentPage=this.currentPage)})}};window.customElements.define("cagov-pagination",V);var st=document.createElement("style");st.textContent=Nt;document.querySelector("head").appendChild(st);var F=class extends window.HTMLElement{connectedCallback(){this.innerHTML=`<div class="accordion-icon" aria-hidden="true">
        <svg viewbox="0 0 25 25">
            <title>Plus</title>
            <line x1="6" y1="12.5" x2="19" y2="12.5" fill="none" stroke="currentColor" stroke-width="6" stroke-linecap="round" vector-effect="non-scaling-stroke" />
...
/*# sourceMappingURL=index.css.map */
`,_=class extends window.HTMLElement{connectedCallback(){this.type="wordpress",function(){function a(){let t=window,n=document;if(!("scrollBehavior"in n.documentElement.style&&t.__forceSmoothScrollPolyfill__!==!0)){let r,v=t.HTMLElement||t.Element;var e=468,o={scroll:t.scroll||t.scrollTo,scrollBy:t.scrollBy,elementScroll:v.prototype.scroll||s,scrollIntoView:v.prototype.scrollIntoView},i=t.performance&&t.performance.now?t.performance.now.bind(t.performance):Date.now,m=(r=t.navigator.userAgent,new RegExp(["MSIE ","Trident/","Edge/"].join("|")).test(r)?1:0);t.scroll=t.scrollTo=function(){arguments[0]!==void 0&&(h(arguments[0])!==!0?k.call(t,n.body,arguments[0].left!==void 0?~~arguments[0].left:t.scrollX||t.pageXOffset,arguments[0].top!==void 0?~~arguments[0].top:t.scrollY||t.pageYOffset):o.scroll.call(t,arguments[0].left!==void 0?arguments[0].left:typeof arguments[0]!="object"?arguments[0]:t.scrollX||t.pageXOffset,arguments[0].top!==void 0?arguments[0].top:arguments[1]!==void 0?arguments[1]:t.scrollY||t.pageYOffset))},t.scrollBy=function(){arguments[0]!==void 0&&(h(arguments[0])?o.scrollBy.call(t,arguments[0].left!==void 0?arguments[0].left:typeof arguments[0]!="object"?arguments[0]:0,arguments[0].top!==void 0?arguments[0].top:arguments[1]!==void 0?arguments[1]:0):k.call(t,n.body,~~arguments[0].left+(t.scrollX||t.pageXOffset),~~arguments[0].top+(t.scrollY||t.pageYOffset)))},v.prototype.scroll=v.prototype.scrollTo=function(){if(arguments[0]!==void 0)if(h(arguments[0])!==!0){let g=arguments[0].left,l=arguments[0].top;k.call(this,this,g===void 0?this.scrollLeft:~~g,l===void 0?this.scrollTop:~~l)}else{if(typeof arguments[0]=="number"&&arguments[1]===void 0)throw new SyntaxError("Value could not be converted");o.elementScroll.call(this,arguments[0].left!==void 0?~~arguments[0].left:typeof arguments[0]!="object"?~~arguments[0]:this.scrollLeft,arguments[0].top!==void 0?~~arguments[0].top:arguments[1]!==void 0?~~arguments[1]:this.scrollTop)}},v.prototype.scrollBy=function(){arguments[0]!==void 0&&(h(arguments[0])!==!0?this.scroll({left:~~arguments[0].left+this.scrollLeft,top:~~arguments[0].top+this.scrollTop,behavior:arguments[0].behavior}):o.elementScroll.call(this,arguments[0].left!==void 0?~~arguments[0].left+this.scrollLeft:~~arguments[0]+this.scrollLeft,arguments[0].top!==void 0?~~arguments[0].top+this.scrollTop:~~arguments[1]+this.scrollTop))},v.prototype.scrollIntoView=function(){if(h(arguments[0])!==!0){let g=function(d){for(;d!==n.body&&(b=A(u=d,"Y")&&$(u,"Y"),f=A(u,"X")&&$(u,"X"),(b||f)===!1);)d=d.parentNode||d.host;let u,b,f;return d}(this),l=g.getBoundingClientRect(),w=this.getBoundingClientRect();g!==n.body?(k.call(this,g,g.scrollLeft+w.left-l.left,g.scrollTop+w.top-l.top),t.getComputedStyle(g).position!=="fixed"&&t.scrollBy({left:l.left,top:l.top,behavior:"smooth"})):t.scrollBy({left:w.left,top:w.top,behavior:"smooth"})}else o.scrollIntoView.call(this,arguments[0]===void 0||arguments[0])}}function s(r,v){this.scrollLeft=r,this.scrollTop=v}function h(r){if(r===null||typeof r!="object"||r.behavior===void 0||r.behavior==="auto"||r.behavior==="instant")return!0;if(typeof r=="object"&&r.behavior==="smooth")return!1;throw new TypeError(`behavior member of ScrollOptions ${r.behavior} is not a valid value for enumeration ScrollBehavior.`)}function A(r,v){return v==="Y"?r.clientHeight+m<r.scrollHeight:v==="X"?r.clientWidth+m<r.scrollWidth:void 0}function $(r,v){let g=t.getComputedStyle(r,null)[`overflow${v}`];return g==="auto"||g==="scroll"}function S(r){let v,g,l,w,d=(i()-r.startTime)/e;w=d=d>1?1:d,v=.5*(1-Math.cos(Math.PI*w)),g=r.startX+(r.x-r.startX)*v,l=r.startY+(r.y-r.startY)*v,r.method.call(r.scrollable,g,l),g===r.x&&l===r.y||t.requestAnimationFrame(S.bind(t,r))}function k(r,v,g){let l,w,d,u,b=i();r===n.body?(l=t,w=t.scrollX||t.pageXOffset,d=t.scrollY||t.pageYOffset,u=o.scroll):(l=r,w=r.scrollLeft,d=r.scrollTop,u=s),S({scrollable:l,method:u,startTime:b,startX:w,startY:d,x:v,y:g})}}typeof exports=="object"&&typeof module<"u"?module.exports={polyfill:a}:a()}(),this.type==="wordpress"&&document.addEventListener("DOMContentLoaded",()=>this.buildContentNavigation()),(document.readyState==="complete"||document.readyState==="loaded")&&this.buildContentNavigation()}buildContentNavigation(){let a=this.getHeaderTags(),t=null;a!==null&&(t=this.dataset.label||"On this page");let n=null;a!==null&&(n=`<nav aria-labelledby="page-navigation-label"> <div id="page-navigation-label" class="label">${t}</div> ${a}</nav>`),this.template({content:n},"wordpress")}template(a,t){return a!=null&&a.content!==null&&t==="wordpress"&&(this.innerHTML=`${a.content}`),document.querySelectorAll("a[data-page-navigation]").forEach(n=>{n.addEventListener("click",e=>{let o=decodeURI(n.getAttribute("href"));try{let i=document.querySelector(o);if(i!==null){let m=i.getBoundingClientRect();window.scrollTo({left:m.left,top:m.top-200}),window.history.pushState(null,null,o)}}catch(i){console.error(i)}e.preventDefault()})}),null}renderNoContent(){this.innerHTML=""}getHeaderTags(){let{selector:a}=this.dataset,t=["h2"];for(let n=0;n<t.length;n+=1)if(a!=null){let e=document.querySelector(a);if(e!==null)return _.outliner(e)}return null}static outliner(a){let t=a.querySelectorAll("h2"),n="";return t!=null&&t.length>0?(t.forEach(e=>{let o=e.getAttribute("id"),i=e.getAttribute("name"),m=e.innerHTML,s=null;o?s=o:i?s=i:s=e.innerHTML;let h=s.toLowerCase().trim().replace(/ /g,"-").replace(/\(|\)|!|"|#|\$|%|&|'|\*|\+|,|\.|\/|:|;|<|=|>|\?|@|\[|\]|\\|\^|`|\{|\||\|\}|~/g,"").replace(/a-zA-ZÃ€-Ã–Ã™-Ã¶Ã¹-Ã¿Ä€-Å¾á¸€-á»¿0-9\u00A0-\u017F/g,"");n+=`<li><a data-page-navigation href="#${encodeURI(h)}">${m}</a></li>`,e.setAttribute("id",h),e.setAttribute("name",h)}),`<ul>${n}</ul>`):null}};customElements.get("cagov-page-navigation")===void 0&&window.customElements.define("cagov-page-navigation",_);var vt=document.createElement("style");vt.textContent=Et;document.querySelector("head").appendChild(vt);function qt(){let c=document.querySelector(".branding .grid-mobile-icons");return c?getComputedStyle(c).display!=="none":!1}function Tt(c,a){c.parentNode.insertBefore(a,c.nextSibling)}var mt=document.querySelector(".sidebar-container"),gt=document.querySelector("h1");qt()&&mt&&gt&&Tt(gt,mt);function Mt(){let c='<span class="pdf-link-icon" aria-hidden="true"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"width="25.1px" height="13.6px" viewBox="0 0 25.1 13.6" style="enable-background:new 0 0 25.1 13.6;" xml:space="preserve"><path d="M11.7,9.9h1.5c1.7,0,3.1-1.4,3.1-3.1s-1.4-3.1-3.1-3.1h-1.5c-0.3,0-0.6,0.3-0.6,0.6v4.9c0,0.2,0.1,0.3,0.2,0.4C11.4,9.9,11.6,9.9,11.7,9.9L11.7,9.9z M12.3,5h0.9c1,0,1.8,0.8,1.8,1.8s-0.8,1.8-1.8,1.8h-0.9V5z"/><path d="M17.8,9.9c0.2,0,0.3-0.1,0.4-0.2c0.1-0.1,0.2-0.3,0.2-0.4V7.5h1.2c0.3,0,0.6-0.3,0.6-0.6c0-0.3-0.3-0.6-0.6-0.6h-1.2V5h2.1c0.3,0,0.6-0.3,0.6-0.6c0-0.3-0.3-0.6-0.6-0.6h-2.8c-0.3,0-0.6,0.3-0.6,0.6v4.9c0,0.2,0.1,0.3,0.2,0.4C17.5,9.9,17.7,9.9,17.8,9.9L17.8,9.9z"/><path d="M6.2,9.9c0.2,0,0.3-0.1,0.4-0.2c0.1-0.1,0.2-0.3,0.2-0.4V8.1H8c1.2,0,2.1-1,2.1-2.1c0-1.2-1-2.1-2.1-2.1H6.2c-0.3,0-0.6,0.3-0.6,0.6v4.9c0,0.2,0.1,0.3,0.2,0.4C5.9,9.9,6,9.9,6.2,9.9L6.2,9.9z M9,6c0,0.3-0.1,0.5-0.2,0.7C8.5,6.8,8.3,6.9,8,6.9H6.8V5H8c0.2,0,0.5,0.1,0.7,0.2C8.9,5.5,9,5.7,9,6L9,6z"/></svg></span><span class="sr-only"> (this is a pdf file)</span>',a=document.querySelectorAll("a[href*='.pdf']");for(let t=0;t<a.length;t+=1)a[t].innerHTML+=c,a[t].innerHTML.indexOf("*PDF (this is a pdf file)*")!==-1&&(a[t].innerHTML+=c.replace(/PDF (this is a pdf file)]/g,""))}Mt();function Ct(){let c='<span class="external-link-icon" aria-hidden="true"><svg version="1.1" x="0px" y="0px" viewBox="0 0 24 24" style="enable-background:new 0 0 24 24;" xml:space="preserve"><path d="M1.4,13.3c0-1.9,0-3.8,0-5.7c0-2.3,1.3-3.6,3.7-3.7c2,0,3.9,0,5.9,0c0.9,0,1.4,0.4,1.4,1.1c0,0.7-0.5,1.1-1.5,1.1 c-2,0-3.9,0-5.9,0c-1.1,0-1.4,0.3-1.4,1.5c0,3.8,0,7.6,0,11.3c0,1.1,0.4,1.5,1.5,1.5c3.8,0,7.6,0,11.3,0c1.1,0,1.4-0.3,1.4-1.5 c0-1.9,0-3.9,0-5.8c0-1,0.4-1.5,1.1-1.5c0.7,0,1.1,0.5,1.1,1.5c0,2,0,4,0,6.1c0,2-1.4,3.4-3.4,3.4c-4,0-7.9,0-11.9,0 c-2.1,0-3.4-1.4-3.4-3.4C1.4,17.2,1.4,15.2,1.4,13.3L1.4,13.3z"/><path d="M19.6,2.8c-1.3,0-2.5,0-3.6,0c-0.9,0-1.4-0.4-1.4-1.1c0.1-0.8,0.6-1.1,1.3-1.1c2.1,0,4.2,0,6.2,0c0.8,0,1.2,0.5,1.2,1.3 c0,2,0,4.1,0,6.2c0,0.9-0.4,1.4-1.1,1.4c-0.7,0-1.1-0.5-1.1-1.4c0-1.1,0-2.3,0-3.6c-0.3,0.3-0.6,0.5-0.8,0.7c-3,3-6,6-8.9,8.9 c-0.2,0.2-0.3,0.3-0.5,0.5c-0.5,0.5-1.1,0.5-1.6,0c-0.5-0.5-0.4-1,0-1.5c0.1-0.2,0.3-0.3,0.5-0.5c3-3,6-6,8.9-8.9 C19,3.4,19.2,3.2,19.6,2.8L19.6,2.8z"/></svg></span>';function a(n){return window.location.host.indexOf(n.host)>-1}document.querySelectorAll("main a, .agency-footer a, .site-footer a, footer a").forEach(n=>{let e=n.href.indexOf("#")===0,o=n.href.indexOf("localhost")>-1,i=n.href.indexOf("@")>-1,m=n;a(m)===!1&&!e&&!i&&!o&&(m.innerHTML+=c)})}Ct();var _t=`/* Back to top button */
...
`,D=class extends window.HTMLElement{static get observedAttributes(){return["data-hide-after","data-label"]}constructor(){super();let a={parentSelector:"cagov-back-to-top",onLoadSelector:"body",scrollBottomThreshold:10,scrollAfterHeight:400};this.options={...a,label:this.dataset.label||"Back to top",hideAfter:Number(this.dataset.hideAfter)||7e3},this.state={lastScrollTop:0,timer:null}}connectedCallback(){document.querySelector(this.options.onLoadSelector).onload=this.addGoToTopButton(),window.addEventListener("scroll",D.debounce(()=>{this.scrollToTopHandler()},200),!1),window.onscroll=D.debounce(()=>{this.checkScrolledToBottom()},200)}checkScrolledToBottom(){let{timer:a}=this.state,t=document.querySelector(".back-to-top");window.innerHeight+window.scrollY>=document.body.offsetHeight&&(t.classList.add("is-visible"),t.removeAttribute("aria-hidden"),t.removeAttribute("tabindex"),clearTimeout(a))}static debounce(a,t,n){let e;return(...o)=>{let i=this,m=()=>{e=null,n||a.apply(i,...o)},s=n&&!e;clearTimeout(e),e=setTimeout(m,t),s&&a.apply(i,...o)}}attributeChangedCallback(a,t,n){a==="data-hide-after"&&(this.options.hideAfter=Number(n)),a==="data-label"&&(this.options.label=n,document.querySelector(".back-to-top")!==null&&(document.querySelector(".back-to-top").innerHTML=this.options.label))}scrollToTopHandler(){let a=document.querySelector(this.options.parentSelector),{lastScrollTop:t}=this.state,{timer:n}=this.state,e=document.querySelector(".back-to-top"),o=window.pageYOffset||document.documentElement.scrollTop;o>t?(e.classList.remove("is-visible"),e.setAttribute("aria-hidden","true"),e.setAttribute("tabindex","-1")):a.scrollTop>=this.options.scrollAfterHeight||document.documentElement.scrollTop>=this.options.scrollAfterHeight?(n!==null&&clearTimeout(n),e.classList.add("is-visible"),e.removeAttribute("aria-hidden"),e.removeAttribute("tabindex"),n=setTimeout(()=>{e.classList.remove("is-visible"),e.setAttribute("aria-hidden","true"),e.setAttribute("tabindex","-1")},this.options.hideAfter)):(e.classList.remove("is-visible"),e.setAttribute("aria-hidden","true"),e.setAttribute("tabindex","-1")),this.state.lastScrollTop=o<=0?0:o}static addStyle(a){let t=document.createElement("span");t.setAttribute("aria-hidden","true"),t.innerHTML=`
      ...
      `,a.insertBefore(t,a.firstChild)}addGoToTopButton(){let a=document.querySelector(this.options.parentSelector),t=document.createElement("button");t.classList.add("back-to-top"),t.setAttribute("aria-hidden","true"),t.setAttribute("tabindex","-1");let n=document.createTextNode(this.options.label);t.appendChild(n),D.addStyle(t),a.append(t),t.addEventListener("click",()=>this.goToTopFunction())}goToTopFunction(){document.querySelector(this.options.onLoadSelector).scrollTop=0,window.scroll({top:0,behavior:"smooth"})}};window.customElements.define("cagov-back-to-top",D);var lt=document.createElement("style");lt.textContent=_t;document.querySelector("head").appendChild(lt);var J=class extends window.HTMLElement{connectedCallback(){this.type="wordpress",this.message=this.dataset.message||"",this.icon=this.dataset.icon||"",this.type==="wordpress"&&document.addEventListener("DOMContentLoaded",()=>{this.template({message:this.message,icon:this.icon},"wordpress"),document.querySelector("cagov-page-alert .close-button").addEventListener("click",a=>{document.querySelector("cagov-page-alert").style.display="none"})})}template(a,t){return a!=null&&a.content!==null&&t==="wordpress"&&(this.innerHTML=`<div class="cagov-page-alert cagov-stack"><div class="icon"><span class="${this.icon}"></span></div>
        <div class="body">${this.message}</div>
        <div class="close-button"><span class="ca-gov-icon-close-line"></span></div></div>`),null}};customElements.get("cagov-page-alert")===void 0&&window.customElements.define("cagov-page-alert",J);var Ht="May 26, 2022",$t="/assets/img/usdm-assets/20220524_usdm_excerpt.png",Z={dateString:Ht,filePath:$t};var Q=class extends window.HTMLElement{connectedCallback(){console.log("Loading Drought Map"),this.type="wordpress",this.type==="wordpress"&&document.addEventListener("DOMContentLoaded",()=>{this.template({},"wordpress")})}template(a,t){return a!=null&&a.content!==null&&t==="wordpress"&&(this.innerHTML=`<div class="cagov-drought-map">
                <p class="map-label">Released ${Z.dateString}. Updates automatically each Thursday.</p>

                <p>Click the map to see the intensity of drought conditions in California:</p>
                <div class="drought-map-container">
                  <div class="drought-map-image"><a href="https://droughtmonitor.unl.edu/CurrentMap/StateDroughtMonitor.aspx?CA"><img src="${Z.filePath}" /></a></div>
            ...
            </div>`),null}};customElements.get("cagov-drought-map")===void 0&&window.customElements.define("cagov-drought-map",Q);var dt=`.popover-content {
  position: absolute;
  display: flex;
...
.popover-stat {
  margin: 0 0 .5rem 0;
}`;var G=class extends window.HTMLElement{constructor(a,t){super();let n=document.createElement("template");n.innerHTML=a;let e=document.createElement("style");e.append(dt),n.content.prepend(e),this.attachShadow({mode:"open"}),this.shadowRoot.append(n.content.cloneNode(!0)),this.shadowRoot.querySelector("style").append(t)}buildPopOverElement({container:a,x:t,y:n,legendSvg:e,legendText:o,content:i,xOffsetM:m="0%"}){let s=document.createElement("div");return s.setAttribute("tabindex","0"),s.classList.add("popover-content"),s.style.setProperty("--x",t),s.style.setProperty("--y",n),s.style.setProperty("--x-offset-m",m),s.innerHTML=`
      <div class="popover-legend">
        ${e}
        <p class="popover-header">${o}</p>
      </div>
      <p class="popover-stat">${i}</p>
    `,a.append(s),s}setUpPopOvers(a,t){t.addEventListener("mouseover",n=>{a.classList.add("popover-revealed"),t.classList.add("highlighted")}),a.addEventListener("focus",n=>{a.classList.add("popover-revealed"),t.classList.add("highlighted")}),t.addEventListener("mouseout",n=>{a.classList.remove("popover-revealed"),t.classList.remove("highlighted")}),a.addEventListener("blur",n=>{a.classList.remove("popover-revealed"),t.classList.remove("highlighted")})}},O=G;var pt=`.reservoir-data-viz {
  display: flex;
...
</div>`;var tt=class extends O{constructor(){super(ht,pt)}connectedCallback(){let a=parseInt(this.dataset.currentTaf),t=parseInt(this.dataset.historicalTaf),n=parseInt(this.dataset.capacityTaf),e=Math.round(100*a/n),o=Math.round(100*t/n),i=135,m=Math.round(i-i*o/100),s=m-5,h=Math.round(i-i*e/100),A=Math.round(i*e/100),$=this.shadowRoot.querySelector(".popover-container"),S=150,k=150,r=this.shadowRoot.querySelector("#current-popover"),v=(S-28)/S*100;r.setAttribute("style",`--x:${v}%; --y:70%; --x-offset-m:65%;`);let g=this.shadowRoot.querySelector("#basin-water");g.setAttribute("y",h),g.setAttribute("height",A),this.setUpPopOvers(r,g);let l=this.shadowRoot.querySelector("#historical-popover"),w=(S-8)/S*100;l.setAttribute("style",`--x:${w}%; --y:23%; --x-offset-m:65%;`);let d=this.shadowRoot.querySelector("#historical-line"),u=this.shadowRoot.querySelector("#historical-line-hover-target");d.setAttribute("y1",m),d.setAttribute("y2",m),u.setAttribute("y",s),this.setUpPopOvers(l,u);let b=this.shadowRoot.querySelector("#capacity-popover"),f=(S-8)/S*100;b.setAttribute("style",`--x:${f}%; --y:50%; --x-offset-m:65%;`);let T=this.shadowRoot.querySelector("#basin-capacity");this.setUpPopOvers(b,T)}};window.customElements.define("drought-reservoir-levels",tt);var wt=`.snowpack-data-viz-overall {
  color: #B71234;
