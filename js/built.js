      ...
      if (data !== undefined && data !== null && data.content !== null) {
        if (type === "wordpress") {
          this.innerHTML = `<div class="cagov-drought-map">
                <div class="map-label"><h2>Map released: July 7, 2021</h2></div>
                <div class="drought-map-image"><a href="https://droughtmonitor.unl.edu/"><img src="/assets/img/20210629_usdm_excerpt.png" /></a></div>
